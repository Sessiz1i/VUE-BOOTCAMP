<template>
  <aside class="bg-gray-700 sm:w-[300px] sm:h-screen w-full">
    <h3 class="text-2xl font-bold mt-2 p-2">Fatura Listesi</h3>
    <div v-for="item in invoiceList" :key="item.id" class="odd:bg-gray-600 flex justify-between items-center p-2">
...
<script setup>
const {invoiceList:invoiceList} = defineProps({invoiceList: Array})
